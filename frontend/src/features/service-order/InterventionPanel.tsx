...
export function InterventionPanel({
  ...
  return (
    <section className="card">
      ...
      {isAdministrator ? null : isDelivered ? (
        <p className="state-message">La orden ya fue entregada. Las intervenciones están cerradas para edición.</p>
      ) : !isAssignedToMe || !canEdit ? (
        <p className="state-message">Esta orden no está asignada a su usuario. No puede registrar intervenciones.</p>
      ) : (
