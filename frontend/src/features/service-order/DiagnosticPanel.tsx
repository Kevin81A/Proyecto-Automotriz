  ...
  return (
    <section className="card">
      ...
      {isAdministrator ? (
        ...
        <p className="state-message">La orden ya fue entregada. El diagnóstico está cerrado para edición.</p>
      ) : !isAssignedToMe || !canEdit ? (
        <p className="state-message">Esta orden no está asignada a su usuario. No puede registrar el diagnóstico.</p>
      ) : (
